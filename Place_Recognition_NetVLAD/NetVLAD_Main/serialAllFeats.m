...
%         for k = 1:(iEnd-iStart+1)
%             thisImageFns{k} = strcat(thisImageFns{k}(1), thisImageFns{k}(2));
%         end
% 
        thisNumIms= iEnd-iStart+1;
        
        ims_= vl_imreadjpeg(thisImageFns,'numThreads', opts.numThreads,'Resize',[692 681],'CropAnisotropy',[1 1],'CropSize',[1 1],'CropLocation','center');
